  		...
  		<div class="container-fluid">
			<div class="row">
	 		<div class="col-12 col-lg-12">
	   			<div class="card">
	     			<div class="card-header">인플루언서 목록</div>
							...
							<div class="d-flex py-3">
								...
								<div class="col-4 d-flex">
			    					<select id="shOption" class="form-control" name="shOption">
						                ...
						                <option value="1" <c:if test="${vo.shOption eq 1}">selected</c:if>>인플루언서 이름</option>
			    					</select>
	               			...
	               			<div class="form-group d-flex justify-content-center">
								<button type="button" class="btn btn-light" onclick="location.href='influencerForm'">추가</button>
...
<script>
	...
	$("#btnModification").click(function() {
		...
		if (checkedItems.length > 0) {
			var url = "influencerForm?seq=" + checkedItems.join(",");
			location.href = url;
		}
