  		...
  		<div class="container-fluid">
			<div class="row">
	 		<div class="col-12 col-lg-12">
	   			<div class="card">
	     			<div class="card-header">코드그룹목록</div>
		       			<div class="table align-items-center table-flush table-borderless">
		       					...
		       					<div class="d-flex py-3">
									...
									<div class="col-4 d-flex">
				    					<select id="shOption" class="form-control" name="shOption">
							                ...
							                <option value="1" <c:if test="${vo.shOption eq 1}">selected</c:if>>코드그룹명</option>
				    					</select>
							...
							<div class="form-group d-flex justify-content-center">
								<button type="button" class="btn btn-light" onclick="location.href='codeGroupForm'">추가</button>
