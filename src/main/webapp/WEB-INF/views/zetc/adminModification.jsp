	    ...
	    <div class="pagetitle">
      		...
      		<nav>
        		<ol class="breadcrumb">
          			...
          			<li class="breadcrumb-item active">데이터 수정</li>
        		</ol>
      		</nav>
    	</div>
	    <div class="col-lg-12">
          	<div class="card">
            	<div class="card-body">
              		<h5 class="card-title">선택한 테이블</h5>
              		<p>정보수정 설명</p>
              		...
              		<form class="row g-3 needs-validation" novalidate>
                		...
                		<div class="d-flex justify-content-center">
							<button class="btn btn-outline-secondary" id="submitForm" type="submit">저장</button>
							<button class="btn btn-outline-secondary btnCancel" type="button">뒤로</button>
						</div>
              		</form>
            	</div>
          	</div>
